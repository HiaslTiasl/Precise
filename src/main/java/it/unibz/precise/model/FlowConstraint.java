...
@Entity
@JsonIdentityInfo(generator=ObjectIdGenerators.IntSequenceGenerator.class, property="@id", scope=FlowConstraint.class)
@JsonIdentityReference(alwaysAsId=false)
public class FlowConstraint extends BaseEntity {
